...
export default class AddProductComponent extends ValidationComponent {
  ...
  selectPhotoTapped = async () => {
    ...
    if (!result.cancelled) {
      if (this.state.prodImageURLs.length === 0) {
      ...
      } else if (this.state.prodImageURLs.length === 1) {
      ...
      } else if (this.state.prodImageURLs.length === 2) {
  ...
  addProduct = () => {
    if ((this.state.uploading = "")) {
      ...
      (this.state.uploading = "started" & (this.state.imageUploaded == true))
    ) {
            ...
            {prodImage1 ? (
              <View style={styles.prodImage}>
                ...
                <TouchableHighlight
                  ...
                  onPress={() => this.selectPhotoTapped()}
                >
                  <Text style={styles.selectImageText}>Select Other Image</Text>
                </TouchableHighlight>
                </View>
              </View>
            ) : null}
